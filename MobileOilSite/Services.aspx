...
<center>
    <div style="padding-bottom:30px; padding-top:30px;">
        <div style="margin-top: 0px; width: 310px;" class="s1" id="comp-ig2akd9t">
            <h2 style="text-align: center;" class="font_2">
                <span class="color_13"><span style="letter-spacing: 0.05em;">SERVICES</span></span></h2>
        </div>
        <div style="width: 116px; height: 10px;" class="s12" id="comp-ig97ifbc">
...
<div class="col-lg-3 col-md-5 col-sm-5 col-xs-9">
    <div>  <%-- left:10px; --%>
        <img alt="" src="Product_Images/Prod1/Prod_1.jpg" style="width: 300px; height: 227px; object-fit: cover;">
    </div> 
    ...
    <p style="line-height: 1.6em;" class="font_8">
        <span style="line-height: 1.6em;">Byco Intelu diesel engine oil grades are formulated with imported Group II 
        base oil with triguard advantage that offers less evaporation, unbeatable protection and increases performance for a variety ....</span></p>
    </div>
</div>

<div class="col-lg-3 col-md-5 col-sm-5 col-xs-9">
  <div><%--left:328px;--%>
        <img alt="" src="Product_Images/Prod2/Prod_2.jpg" style="width: 300px; height: 227px; object-fit: cover;">
    </div>
       <div style="margin-top:35px;">
        <h6 style="line-height: 1.1em;" class="font_6">
     ...
     <div class="s11" style="margin-top:15px;">
    <p style="line-height: 1.6em;" class="font_8">
        <span style="line-height: 1.6em;">Byco Cnergy gasoline engine oil are formulated with imported Group II base oil with
         triguard advantage that reduces deposits, exceptionally maintains temperature in gasoline engines performing under .... </span></p>
    </div>
</div>
...
<div class="col-lg-3 col-md-5 col-sm-5 col-xs-9">
 <div><%--left:648px;--%>
        <img alt="" src="Product_Images/Prod3/Prod_3.jpg" style="width: 300px; height: 227px; object-fit: cover;">
    </div>
       <div style="margin-top:35px;">
         <h6 style="line-height: 1.1em;" class="font_6">
    ...
    <div class="s11" style="margin-top:15px;">
    <p style="line-height: 1.6em;" class="font_8">
        <span style="line-height: 1.6em;">Exceptional quality specifically formulated multi-grade four stroke motorcycle engine 
        oil for achieving high power and performance. Provides excellent engine cleanliness  and gear protection.</span></p>
    </div>
</div>
...
<div class="col-lg-3 col-md-5 col-sm-5 col-xs-9">
   <div><%--left:648px;--%>
        <img alt="" src="Product_Images/Prod4/Prod_4.jpg" style="width: 300px; height: 227px; object-fit: cover;">
    </div>
      <div style="margin-top:35px;">
         <h6 style="line-height: 1.1em;" class="font_6">
      ...
      <div class="s11" style="margin-top:15px;">
    <p style="line-height: 1.6em;" class="font_8">
        <span style="line-height: 1.6em;">Byco ORA range of lubricants is a premium performance, anti-wear hydraulic fluid 
        designed for use in mobile and stationary high pressure industrial & agrifarm hydraulic systems. They resist breakdown under....</span></p>
    </div>
</div>
    <%--<div class="row">--%>
    ...
    <%--</div>--%>
        ...
        <div class="s10" style="background-color: #F7F7F7;" >
