<%@ Control Language="C#" AutoEventWireup="true" CodeFile="Products_Default.ascx.cs"
    Inherits="Products_Default" %>
<center>
    <div style="top: 56px; margin-left: 15px" class="" id="">
        <h2 class="font_2">
            <span class="color_13"><span style="letter-spacing: 0.05em;">PRODUCTS</span></span>
        </h2>
    </div>
    <div style="top: 20px; width: 116px; height: 10px; margin-bottom: 20px;" class="s16"
        id="comp-ig97s470">
